...
class MainScreenController:
    ...
    def get_content_screen(self, subject):
        """
        Pass the subject to Controller.content_screen.ContentScreenController
        and fetch the contents from Model.content_screen.ContentScreenModel
        """
